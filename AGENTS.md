...
This file provides guidance to Various Coding Agents that support AGENTS.MD (agents.md) when working with code in this repository.
...
2. **Map Configuration**
   ...
   - Different color schemes for feature types:
     - Mountains: Brown outline with tan fill (30% opacity)
     - Rivers: Dark blue polylines (thicker for visibility)
     - Lakes: Cyan outline and fill (30% opacity)
...
- Input validation prevents empty answer submissions
- Accessibility features include ARIA labels for screen readers
- Proper state management ensures clean transitions between categories and quiz restarts
